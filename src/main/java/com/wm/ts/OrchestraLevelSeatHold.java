...
public class OrchestraLevelSeatHold {
    ...
    public static void seatHold() throws IOException {  // the MAIN method program
       System.out.println("Seats Available in ORCHESTRA Level by Seat Number ");
        ...
        do {                                                    // Loop until user press X to exit
            ...
            if (chkFull())
            {
                System.out.println("seathold is FULL");
                inData="Seat Hold";
            }
            else 
            {     
            	System.out.println("Enter email id to Hold Seat");
            	String customeremail=input.next();
                System.out.print("Enter Seat number to hold Seat: ");
                inData = input.next();
                if (chkData(inData))
                    System.out.println("Seat Hold Successful for coustomer:"+customeremail);
                
                else
                    System.out.println("Seat alrady Hold!");
            }       
