...
public class MainLevelSeatHold {
    ...
    public static void seatHold() throws IOException {  // the MAIN method program
       System.out.println("Seats Available in Main Level by Seat Number ");
        ...
        do {                                                    // Loop until user press X to exit
            ...
            {     
                ...
                inData = input.next();
                if (chkData(inData))
                    System.out.println("seatHold Successful for coustomer:"+customeremail);
                
                else
                    System.out.println("Occupied Seat!");
            }       
        } while (!inData.equalsIgnoreCase("seatHold"));
